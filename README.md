...
| [RSAT](Projects/RSAT/README.md) | Extracts 9 admin capabilities (RSAT tools + BitLocker + OpenSSH client) from the Windows 11 "Languages and Optional Features" ISOs into an MECM package source (~286 MB/build), with a context-aware installer for OSD task sequences (WinPE/offline) and full-OS collection deployments. Covers Win11 22H2 through 26H1. Pester-tested. |
